    ...
    setItems((prev) =>
      prev.map((item, i) =>
        i === idx
          ? {
              ...item,
              [field]: field === "service_description" ? value : Number(value),
            }
          : item,
      ),
    )
      ...
      <form onSubmit={handleSubmit}>
            ...
            {items.map((item, idx) => (
              <Box key={idx} display="flex" gap={4} mb={2}>
                <Input
                  ...
                  onChange={(e) =>
                    handleItemChange(idx, "service_description", e.target.value)
                  }
        ...
        <Box mt={4} mb={2}>
          ...
          <Textarea
            ...
            rows={3}
            placeholder="e.g. Pay within 7 days via bank transfer or mobile money."
          />
        </Box>
        <Button
          type="submit"
