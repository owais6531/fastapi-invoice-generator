...
function main() {
    ...
    const installationSteps = [
        ...
        {
            description: "Installing File Upload",
            command: "npm install react-dropzone@^14.3.5"
        },
        {
        ...
        {
            description: "Installing UI Components",
            command: "npm install react-select@^5.8.3 react-number-format@^5.4.2"
        },
        {
            description: "Installing File Processing",
            command: "npm install file-saver@^2.0.5 xlsx@^0.18.5"
        },
        {
            description: "Installing PDF Generation",
            command: "npm install jspdf@^2.5.2 html2canvas@^1.4.1"
        },
        {
            description: "Installing Type Definitions",
            command: "npm install --save-dev @types/file-saver@^2.0.7"
        }
    ];
